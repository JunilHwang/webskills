    ...
    <form action="<?php echo $param->get_page?>" method="post" onsubmit="submitContents(this); return false;" enctype="multipart/form-data">
        ...
        <ul class="row">
            <li class="col s12 input-field">
                <input id="tour_subject" name="subject" type="text" class="validate" required>
                <label for="tour_subject">제목</label>
            </li>
            <li class="col s12 input-field">
                <input id="tour_tag" name="tag" type="text" class="validate" required>
                <label for="tour_tag">태그</label>
            </li>
        ...
        <div class="row center">
            <button type="submit" class="btn blue waves-effect waves-light">전송</button>
            <button type="button" class="btn blue waves-effect waves-light layer_close">취소</button>
        </div>
    </form>
</div>
